...
import 'cnr900t_screen.dart';
import 'cnr900t_details.dart';
import 'cnr900t_assembly.dart';
import 'cnr900t_trouble.dart';

class Cnr900tMenuScreen extends StatelessWidget {
  const Cnr900tMenuScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("CNR-900T MENU",
            style: GoogleFonts.blackOpsOne(color: Colors.cyanAccent)),
        backgroundColor: Colors.black,
        leading: IconButton(
            ...
            child: Column(
              ...
              children: [
                _buildNeonButton(
                    context,
                    "1. RADIO OPERATION",
                    "ฝึกการตั้งความถี่ (Full Keypad)",
                    Icons.settings_remote, () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Cnr900tScreen()));
                }),
                ...
                _buildNeonButton(context, "2. SPECIFICATION & 3D",
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Cnr900tDetailScreen()));
                }),
                const SizedBox(height: 20),
                _buildNeonButton(context, "3. ASSEMBLY TRAINING",
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Cnr900tAssemblyScreen()));
                }),
                const SizedBox(height: 20),
                _buildNeonButton(
                    context,
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Cnr900tTroubleScreen()));
                }),
              ],
            ),
          ),
                      ...
                      children: [
                        Text(title,
                            style: GoogleFonts.blackOpsOne(
                                ...
                                shadows: [
                                  const Shadow(
                                      blurRadius: 5, color: Colors.cyanAccent)
                                ])),
